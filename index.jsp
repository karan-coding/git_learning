...
<%@page import="com.Modle.EducationModle"%>
					...
					<div class="about-text">
						...
						<h1 class="animated animated-text">
							...
							<div class="animated-info">
								<span class="animated-item">karan kumar</span> <span
									class="animated-item">Web Designer</span> <span
									class="animated-item">UI Specialist</span>
							</div>
						</h1>
					...
					%>
						...
						<div class="item">
							<div class="project-info">
								<img src="myProject/<%=file.getFileName()%>" class="img-fluid"
									alt="project image">
							</div>
						</div>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-12">
					...
					<div class="timeline">
					  ...
					  <%
					 ReadContactImp readcontact2 =new ReadContactImp();
					        List<EducationModle> edulist=readcontact2.readEducation();
					        for(EducationModle educationModle: edulist){
					  %>
					
						<div class="timeline-wrapper">
							<div class="timeline-yr">
								<span><%=educationModle.getYear() %></span>
							</div>
							
							
							<div class="timeline-info">
								<h3>
									<span> <%=educationModle.getTitle() %></span><small> <%=educationModle.getSubtitle() %></small>
								</h3>
								<p> <%=educationModle.getDescription() %>
									</p>
							</div>
						</div>
			...
			<div class="row">
				...
				<div class="col-lg-5 mr-lg-5 col-12">
					<div class="google-map w-100">
						<iframe
							src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3608.328505060378!2d86.98853637483946!3d25.259532429174083!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f036036989f81d%3A0x98ca4066cd56687d!2sS.M%20College%20Rd%2C%20Khanjarpur%2C%20Bhagalpur%2C%20Bihar%20812001!5e0!3m2!1sen!2sin!4v1734754142387!5m2!1sen!2sin"
